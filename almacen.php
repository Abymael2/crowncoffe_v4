  ...
  <div class="row row-cols-1 row-cols-md-3 g-4 px-5">
    <div class="col">
      <div class="card  text-center bg-primary fw-bold fs-3">
        <a href="inv-alm-categoria.php" class="text-decoration-none">
          <div class="p-2">
            <img src="./img/categoria.png" class="" alt="..." style="height:16vh;">
          </div>
    ...
    <div class="col">
      <div class="card  text-center bg-primary fw-bold fs-3">
        <a href="inv-alm-producto.php" class="text-decoration-none">
          <div class="p-2">
            <img src="./img/producto.png" alt="..." style="height:16vh;">
          </div>
          <div class="card-body text-secondary">
            <p>Menú</p>
          </div>
    ...
    <div class="col">
      <div class="card  text-center bg-primary fw-bold fs-3">
        <a href="inv-alm-ingrediente.php" class="text-decoration-none">
          <div class="p-2">
            <img src="./img/ingredientes.png" alt="..." style="height:16vh;">
          </div>
          <div class="card-body text-secondary">
            <p>Ingrediente</p>
          </div>
