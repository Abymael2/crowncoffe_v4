<?php 
    ...
    $consulta2="SELECT * FROM tbcajaefectivo WHERE id=$valid ";
    ...
    if ($datos2=mysqli_fetch_array($registro2)) {
        ...
        $cajahorai = $datos2['hora_apertura'];
		$usuarioF=$datos2['usuariofin'];
        $cajahoraf = $datos2['hora_cierre'];
        $cajafecha = $datos2['fecha'];
...
<html lang="en">
    ...
    <div class="container text-primary">
        <div class="row">
            <div class="col-6 p-2">
                <label for="formGroupExampleInput" class="form-label ">Fecha de caja</label>
                <input name = "fecha" type="datetime" class="form-control" id="fecha" value ="<?php echo $cajafecha  ?>" disabled>
            </div>
            <div class="col-6 p-2">
            ...
            <div class="col-6 p-2">
                <label for="formGroupExampleInput" class="form-label ">Aperturado por</label>
                <input name = "user" type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $usuarioI?>" disabled>
            </div>
            <div class="col-6 p-2">
                <label for="formGroupExampleInput" class="form-label ">Cerrado por</label>
                <input name = "user" type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $usuarioF?>" disabled>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid px-5 table-responsive-lg text-primary">
            ...
            <!-- Efectivo inicial -->
            <?php 
                    $cons_efectivo = "SELECT * FROM tbcajaefectivo WHERE id=$valid;";
