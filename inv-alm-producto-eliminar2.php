...
<div class="modal fade text-dark" id="modal_eliminar<?php echo $row["id_pro_ing"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <a href="inv-alm-producto-eliminar-ok2.php?id=<?php echo $row["id_pro_ing"] ?>" role="button" class="btn btn-outline-danger">Elimianr</a>
